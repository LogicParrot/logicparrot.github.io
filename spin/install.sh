...
missingPrograms()
{
	...
	sudo apt-get install byacc flex gcc make wget perl || error "Failed to install dependencies. Sorry! Try again, or try running as root, or try installing above dependencies manually"
